...
<head>
    ...
    <title>@yield('title', 'Al-Hidayah')</title>
...
@yield('content')
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2020 <a href="https://bapeten.go.id">Bagian Data dan Informasi - Bapeten</a>.</strong> All rights
        reserved.
    </footer>
