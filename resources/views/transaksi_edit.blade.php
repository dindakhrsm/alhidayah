...
@section('title', 'Al-Hidayah | Edit Transaksi')
                        ...
                        <form method="post" action="{{url('/transaksi/update/'.$transaksi->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="jenis">
                                    ...
                                    <option <?php if($transaksi->jenis == "Pengeluaran"){echo "selected='selected'";}?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="kategori">
                                    ...
                                    @foreach($kategori as $k)
                                        <option
                                            <?php if($k->id == $transaksi->kategori_id){
                                                echo "selected='selected'"; } ?> value="{{ $k->id }}">{{ $k->kategori}}</option>
                                    @endforeach
                                </select>
                                @if($errors->has('kategori'))
                                    <span class="text-danger">
                                        <strong>{{ $errors->first('kategori') }}</strong></span>
                                @endif
                            </div>
                            <div class="form-group">
                                <label>Nominal</label>
                                <input
                                        type="number"
                                        name="nominal"
                                        class="form-control" value="{{ $transaksi->nominal }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea
                                        class="form-control" name="keterangan">{{$transaksi->keterangan }}</textarea>
