...
@section('title', 'Al-Hidayah | Edit Kategori Foto')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{route('backend.kategorigaleri.index')}}">Kategori</a></li>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body ">
                            {!! Form::model($category, [
                           'method'=> 'PUT',
                           'route' => ['backend.kategorigaleri.update', $category->id],
                           'files' => TRUE
  ]                       )!!}
                          ...
                          <span class="glyphicon glyphicon-calendar"></span>
                            ...
                            @include('backend.kategorigaleri.form')
                            {!! Form::close() !!}
                        </div>
...
@include('backend.kategorigaleri.script')
