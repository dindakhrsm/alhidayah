...
class CategoriesController extends BackendController
{
    ...
    public function update(Requests\CategoryUpdateRequest $request, $id)
    {
        ...
        return redirect('backend/categories')->with('message', 'kategori telah berhasil diubah!');
    }
    ...
    public function destroy($id)
    {
      ...
      Category::findOrFail($id)->delete();
        return redirect('backend/categories')->with('message', 'kategori telah berhasil dihapus!');
    }
}
